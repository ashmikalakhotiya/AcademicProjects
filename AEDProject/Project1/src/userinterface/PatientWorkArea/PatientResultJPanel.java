...
public class PatientResultJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form PatientResultJPanel
     */
    public PatientResultJPanel(JPanel userProcessContainer, WorkRequest request, UserAccount userAccount, Enterprise enterprise, EcoSystem business, PatientOrganization organization) {
        initComponents();
        ...
        populateMedicinesDetails();
    }

    public void populateMedicinesDetails() {
        lblValue.setText(request.getMessage());
        textmed1.setText(request.getMedicine1());
        textmed2.setText(request.getMedicine2());
        textmed3.setText(request.getMedicine3());
        textdosage1.setText(request.getDosage1());
        textdosage2.setText(request.getDosage2());
        textdosage3.setText(request.getDosage3());
        textResult.setText(request.getTestResult());
        textDate.setText(String.valueOf(request.getResolveDate()));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(textmed1, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(textmed2, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(textmed3, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(lblProb))
                                .addGap(162, 162, 162)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(textdosage2, javax.swing.GroupLayout.DEFAULT_SIZE, 268, Short.MAX_VALUE)
                                    .addComponent(textdosage3)
                                    .addComponent(textdosage1)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(2, 2, 2)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(textDate, javax.swing.GroupLayout.DEFAULT_SIZE, 385, Short.MAX_VALUE)
