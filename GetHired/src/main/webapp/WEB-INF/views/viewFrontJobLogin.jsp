    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" action = "loginFront.htm" method = "post">
            ...
            <div class="checkbox">
              ...
              <input type="hidden" name="postedby" value="${requestScope.postedby}">
              <input type="hidden" name=receiver value="${requestScope.receiver}">
